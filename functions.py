...
Functions are a common feature among all programming languages.
...
Once defined, you can call the function by using the function name and supplying an argument (if necessary)

demo_func(6) # ===> prints 10
...
standard_arg(2)                                  # ===> prints 2
pos_only_arg(2)                                  # ===> prints 2
kwd_only_arg(arg=2)                              # ===> prints 2
combined_example(2, 2, kwd_only=2)               # ===> prints 2 2 2
combined_example(2, standard=2, kwd_only=2)      # ===> prints 2 2 2
...
This is useful when:
- parameter names have no real meaning
...
...or you want to prevent users from relying on the position of the argument being passed.
